  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('HWBirthData',{id})}>
          <Text style={styles.buttonText}>Search Records</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button2} onPress={() => navigation.navigate('HWBData')}>
          <Text style={styles.buttonText1}>View All Records</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('HWAddBirth')}>
