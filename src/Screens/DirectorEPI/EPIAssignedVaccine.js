...
export default function EPIAssignedVaccine({navigation}) {
...
return (
  <View style={styles.container}>
      ...
      <FlatList
      data={persons}
      renderItem={({ item }) => <Text style={styles.item}>Vaccine: {item.vaccine}{'\n'}{'\n'}Hospital Id: {item.hid}{'\n'}{'\n'}Hospital Name: {item.hname}</Text>}
