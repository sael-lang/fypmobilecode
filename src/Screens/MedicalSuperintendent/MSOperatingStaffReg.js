...
export default function MSOperatingStaffReg({navigation}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>Operating Staff Registration</Text>
      <Text style={styles.headingdesc}>Register new Operating Staff</Text>
